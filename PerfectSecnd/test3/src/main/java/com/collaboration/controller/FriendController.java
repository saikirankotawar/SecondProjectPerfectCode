...
//		friend.setUserId(loggedInUserID);
	...
	{
		int uid = Integer.parseInt(session.getAttribute("loggedInUserId").toString());
		System.out.println("\nuser id : " + uid);
		System.out.println("\nfriend id : " + friendId);
		Friend fr = friendDAO.get(uid,friendId);
		System.out.println("\nFriend Object : " + fr);
		//System.out.println("\nFriend obj id in controller : " +friend.getId() );
		System.out.println("\nFriend obj id in controller : " +fr.getId() );
		System.out.println("\nUser id : " +session.getAttribute("loggedInUserId") );
		System.out.println("\nReq. Friend id : " +friendId );
		//System.out.println("\n Friend id : " +friend.getFriendId() );
		System.out.println("\n Friend id : " +fr.getFriendId() );
		int loggedInUserID = (Integer)session.getAttribute("loggedInUserId");
//		friend.setId(22);
		/*
		friend.setUserId(loggedInUserID);
